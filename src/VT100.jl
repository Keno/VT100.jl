    ...
    while idx <= length(params)
        ...
        elseif f1 == 38
            ...
            if f2 == 2
                ...
                set_cur_cell(em,Cell(cell, fg_rgb = RGB8(f3/255, f4/255, f5/255), flags=cell.flags | FG_IS_RGB))
            elseif f2 == 5
        ...
        elseif f1 == 48
            ...
            if f2 == 2
                idx += 2
                f4, f5 = params[(idx-1):idx]
                set_cur_cell(em,Cell(cell, bg_rgb = RGB8(f3/255, f4/255, f5/255), flags=cell.flags | BG_IS_RGB))
            elseif f2 == 5
